...
const wordBank = [
    ...
    { eng: "explain", ch: "解釋(v.)" },
    { eng: "tutor", ch: "家教老師" },
    { eng: "award", ch: "獎品、獎金(n.); 頒獎(v.)" },
    { eng: "lollipop", ch: "棒棒糖(n.)" },
    { eng: "announce", ch: "宣布(v.)" },
    { eng: "laboratory", ch: "實驗室(n.)" },
    { eng: "strategy", ch: "策略" },
    { eng: "property", ch: "財產、房產、特性(n.)" },
    { eng: "theory", ch: "理論(n.)" },
    { eng: "echo", ch: "回音(n.);發出回音、附和(v.)" },
    { eng: "savings", ch: "存款(n.)" },
    { eng: "dose", ch: "一劑藥劑(n.);給..用藥(v.)" },
    { eng: "pest", ch: "害蟲(n.)" },
    { eng: "bind", ch: "綑綁、結合、裝訂(v.)" },
    { eng: "pronounce", ch: "宣告、發音(v.)" },
    { eng: "glance", ch: "瞥見(n.,v.)" },
    { eng: "glimpse", ch: "瞥見(v.);一瞥、短暫感受(n.)" },
    { eng: "translate", ch: "翻譯(v.)" },
    { eng: "suspect", ch: "懷疑(v.);嫌疑犯(n.)" },
    { eng: "junior", ch: "較年輕的、資淺的(adj.)" },
    { eng: "investigate", ch: "調查(v.)" },
    { eng: "assist", ch: "協助(v.)" },
    { eng: "jelly", ch: "果凍" },
    { eng: "conscious", ch: "有意識的(adj.)" },
    { eng: "replace", ch: "取代(v.) +with" },
    { eng: "significant", ch: "重要的、顯著的(adj.)" },
    { eng: "frequent", ch: "頻繁的(adj.);常出入(v.)" },
    { eng: "frank", ch: "坦白的(adj.)" },
    { eng: "professor", ch: "教授(n.)" },
    { eng: "professional", ch: "專業的(adj.);專業人士(n.)" },
    { eng: "superior to", ch: "優於(adj.);上司(n.)" },
    { eng: "inferior to", ch: "劣於(adj.)" },
    { eng: "minus", ch: "減去(介)" },
    { eng: "plus", ch: "加上(介);而且(連)" },
    { eng: "indoor", ch: "室內的(adj.)" },
    { eng: "outdoor", ch: "室外的(adj.)" }
